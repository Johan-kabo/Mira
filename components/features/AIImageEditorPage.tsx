            ...
            <div className="grid lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="bg-[#1c162d]/50 border border-white/10 rounded-2xl p-8 min-h-[400px] flex flex-col justify-center items-center">
                    ...
                    {!loading && !error && !originalImage && (
                        <p className="text-gray-500">Upload an image and describe your edit.</p>
                    )}
                    {(originalImage && !resultImage && !loading && !error) && (
                        <div className="w-full text-center">
                            <h2 className="text-2xl font-bold text-white mb-4">Original Image</h2>
                            <img src={originalImage} alt="Original to be edited" className="max-w-full max-h-[500px] rounded-lg mx-auto" />
                        </div>
                    )}
                    {resultImage && (
                        <div className="w-full text-center">
